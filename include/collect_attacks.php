...
if(!isset($globals->vision)) {
	print('Vision IP parameter not found.' . NL . NL . usage($usageText));
	exit(1);
}
if(!isset($globals->user)) {
	print('Vision username parameter not found.' . NL . NL . usage($usageText));
	exit(1);
}
if(!isset($globals->pass)) {
	print('Vision password parameter not found.' . NL . NL . usage($usageText));
	exit(1);
}
if(!isset($globals->lower)) {
	print('Lower date parameter not found.' . NL . NL . usage($usageText));
	exit(1);
}
if(!isset($globals->upper)) {
	print('Upper date parameter not found.' . NL . NL . usage($usageText));
	exit(1);
}
